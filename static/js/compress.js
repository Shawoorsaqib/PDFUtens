document.addEventListener("DOMContentLoaded", () => {
    const uploadForm = document.getElementById("compressPdfForm") || document.getElementById("uploadForm");
    const uploadContent = document.getElementById("uploadContent");
    const chooseFileBtn = document.getElementById("chooseCompressBtn") || document.getElementById("chooseFileBtn");
    const fileInput = document.getElementById("compressPdfFileInput") || document.getElementById("fileInput");
    const selectedFilesContainer = document.getElementById("selectedFilesContainer");
    const uploadActions = document.getElementById("uploadActions");
    const uploadBtn = document.getElementById("compressPdfSubmitBtn") || document.getElementById("uploadBtn");
    const uploadStatus = document.getElementById("uploadStatus");
    const successCard = document.getElementById("successCard");
    const downloadBtn = document.getElementById("downloadCompressedBtn") || document.getElementById("downloadBtn");
    ...
    uploadForm.addEventListener("submit", async e => {
        ...
        if (uploadBtn) {
            ...
            uploadBtn.innerHTML = `<i class="bi bi-arrow-repeat spin"></i> Compressing PDF...`;
        }

        if (uploadStatus) {
            uploadStatus.style.display = "block";
            uploadStatus.className = "upload-status upload-loading";
            uploadStatus.textContent = "Compressing PDF, please wait...";
        }
        ...
        try {
            const response = await fetch("/compress-pdf/upload", {
                method: "POST",
                body: formData
            });
            ...
            if (downloadBtn) {
                ...
                downloadBtn.setAttribute("download", data.filename || "compressed.pdf");
                downloadBtn.innerHTML = `<i class="bi bi-download"></i> Download Compressed PDF`;
            }
            ...
            if (uploadBtn) {
                ...
                uploadBtn.innerHTML = `<i class="bi bi-file-earmark-zip-fill"></i> Compress PDF`;
            }
        }
    });
